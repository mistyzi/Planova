...
export default function TabLayout() {
  ...
  const navInnerColors: [string, string] = isDark ? ['rgba(14,25,56,0.96)', 'rgba(14,25,56,0.96)'] : ['rgba(248,250,255,0.96)', 'rgba(248,250,255,0.96)'];
            ...
            screenOptions={{
              ...
              tabBarBackground: () => (
                <LinearGradient
                  ...
                  style={{ flex: 1, borderRadius: 999, padding: 2 }}
                >
