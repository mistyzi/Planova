    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.pageScroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.titleSection}>
          ...
          <Text style={[styles.pageSubtitle, { color: colors.secondaryText }]}>Tools and resources to help you study smarter.</Text>
        </View>
        ...
        <View style={styles.featuredRow}>
          <TouchableOpacity
            ...
            style={[styles.featuredCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}
          >
            <View style={[styles.featuredIcon, { backgroundColor: colors.iconBackground }]}>
            ...
            <Text style={[styles.featuredDescription, { color: colors.secondaryText }]}>Organize your notes and class materials.</Text>
          ...
          >
            ...
            <Text style={[styles.featuredDescription, { color: colors.secondaryText }]}>Set a session and focus on your work.</Text>
            <View style={styles.featuredArrow}>
              <Ionicons name="arrow-forward-outline" size={18} color={colors.secondaryText} />
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.toolsGrid}>
            {studyTools.map((tool) => (
              ...
              >
                <View style={[styles.toolIcon, { backgroundColor: colors.iconBackground }]}>
                  <Ionicons name={tool.icon} size={23} color={colors.icon} />
                </View>
                <Text style={[styles.toolTitle, { color: colors.text }]}>{tool.title}</Text>
                <Text style={[styles.toolDescription, { color: colors.secondaryText }]}>{tool.description}</Text>
              </TouchableOpacity>
            ))}
          </View>
        </View>
