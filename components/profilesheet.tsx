      ...
      >
        <LinearGradient colors={[colors.gradientTop, colors.gradientBottom]} style={styles.gradient}>
          <Image
            ...
            style={styles.avatar}
          />
          <Text style={[styles.name, { color: colors.textPrimary }]}>Hokazono Iroha</Text>
          <Text style={[styles.subtitle, { color: colors.textSecondary }]}>SAIT • Software Development</Text>
          ...
          <TouchableOpacity activeOpacity={0.8} style={[styles.button, { backgroundColor: colors.button }]}>
          ...
          <View style={[styles.settingCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
            <View style={styles.settingTopRow}>
              ...
              <Switch
                ...
                thumbColor="#D9C4FF"
                trackColor={{ false: isDark ? '#3B3B55' : '#D9D4EB', true: '#6E5EFF' }}
              />
            </View>
            ...
            <View style={styles.tagRow}>
              <TouchableOpacity style={[styles.tag, { backgroundColor: colors.tag }]}>
          ...
          <View style={[styles.settingCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
            ...
            <View style={styles.buttonRow}>
              ...
              >
                ...
                <Text style={[styles.themeOptionText, { color: theme === 'light' ? colors.textPrimary : colors.optionText }]}>
                  Stellar
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                ...
                <Text style={[styles.themeOptionText, { color: theme === 'dark' ? colors.textPrimary : colors.optionText }]}>
                  Lunar
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={[styles.settingCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
            <View style={styles.settingRow}>
              <View style={[styles.settingIcon, { backgroundColor: colors.iconBackground }]}>
                <Ionicons name="planet-outline" size={18} color={isDark ? '#F3CFA5' : '#8A6A35'} />
              </View>
              <View style={styles.astralText}>
                <Text style={[styles.settingTitle, { color: colors.textPrimary }]}>Astral Progress Tracking</Text>
                <Text style={[styles.settingDescription, { color: colors.description }]}>
                  Detailed mapping of your intellectual expansion. Visualize subject mastery as expanding nebulae.
                </Text>
              </View>
            </View>
            <View style={styles.buttonRow}>
              <TouchableOpacity style={[styles.option, { borderColor: colors.optionBorder }]}>
                <Text style={[styles.optionText, { color: colors.optionText }]}>Configure Map</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.goldButton, { backgroundColor: colors.gold }]}>
                <Text style={[styles.goldButtonText, { color: colors.goldText }]}>View Universe</Text>
              </TouchableOpacity>
            </View>
          </View>

          <TouchableOpacity activeOpacity={0.8} style={[styles.smallCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
            <View style={styles.settingRow}>
              <View style={[styles.settingIcon, { backgroundColor: colors.iconBackground }]}>
              ...
              <View style={styles.smallText}>
                ...
                <Text style={[styles.smallSubtitle, { color: colors.smallSubtitle }]}>Manage your study visibility</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={isDark ? '#B6A8FF' : '#6658A8'} />
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity activeOpacity={0.8} style={[styles.smallCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
            <View style={styles.settingRow}>
              ...
              <View style={styles.smallText}>
                ...
                <Text style={[styles.smallSubtitle, { color: colors.smallSubtitle }]}>Manage external data streams</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={isDark ? '#B6A8FF' : '#6658A8'} />
            </View>
          </TouchableOpacity>
          ...
          <View style={[styles.deleteCard, { backgroundColor: colors.deleteCard, borderColor: colors.cardBorder }]}>
            ...
            <TouchableOpacity activeOpacity={0.8} style={[styles.deleteButton, { borderColor: colors.deleteBorder }]}>
              <Text style={[styles.deleteButtonText, { color: colors.deleteText }]}>Delete{'\n'}Data</Text>
            </TouchableOpacity>
          </View>
        </LinearGradient>
      </BottomSheetScrollView>
